...
export const CinematicVideoHero: React.FC<CinematicVideoHeroProps> = () => {
  ...
  return (
    ...
    >
      ...
      {/* 4. Minimal Icon-Only Floating Story Controller (Top Right) - Sleek Dark Obsidian Glass */}
      <div className="absolute top-6 right-6 sm:right-10 z-30 flex items-center gap-1.5 p-1.5 rounded-2xl bg-[#0C0614]/85 border border-white/10 shadow-[0_10px_35px_rgba(0,0,0,0.85)] backdrop-blur-xl pointer-events-auto">
        <button
